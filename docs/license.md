...
| Root files with a "Derived from NautilusTrader" or "Modified by Evan Kolberg" notice | LGPL-3.0-or-later | [`../COPYING.LESSER`](../COPYING.LESSER), [`../COPYING`](../COPYING) |
| Everything else such as `main.py`, `Makefile`, docs, and repo metadata | MIT | [`../LICENSE-MIT`](../LICENSE-MIT) |

The full LGPL and GPL texts are in [`../COPYING.LESSER`](../COPYING.LESSER) and
[`../COPYING`](../COPYING). The [`../NOTICE`](../NOTICE) file lists every
...
[`../nautilus_pm/LICENSE`](../nautilus_pm/LICENSE). All files modified or added
...
- forking or redistributing: keep the LGPL license files, the
  [`../NOTICE`](../NOTICE), and the per-file modification headers intact
...
Use [`../LICENSE`](../LICENSE) for the top-level guide and
[`../NOTICE`](../NOTICE) for the file-by-file breakdown.
